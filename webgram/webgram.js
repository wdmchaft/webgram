...
Webgram = function (htmlElement, canvas, settings) {
    ...
    // TODO rename this "change" event and document it
     ...
     * @type Webgram.Event
     */
    this.onBringToFrontAction = new Webgram.Event('bring to front', this); /* (drawingElements, byKeyboard) */
     ...
     * @type Webgram.Event
     */
    this.onSendToBackAction = new Webgram.Event('send to back', this); /* (drawingElements, byKeyboard) */
     ...
     * @type Webgram.Event
     */
    this.onFlipHorizontallyAction = new Webgram.Event('flip horizontally', this); /* (drawingElements, byKeyboard) */
     ...
     * @type Webgram.Event
     */
    this.onFlipVerticallyAction = new Webgram.Event('flip vertically', this); /* (drawingElements, byKeyboard) */
    ...
    this._imageStore.load('end-point-connected', Webgram.imgPath + 'diamond-control-point.png');
    this._imageStore.load('socket', Webgram.imgPath + 'diamond-control-point-empty.png');
    this._imageStore.load('gradient-point', Webgram.imgPath + 'gradient-point.png');
    this._imageStore.load('rotate', Webgram.imgPath + 'square-control-point.png');
    this._imageStore.load('rotation-center', Webgram.imgPath + 'rotation-center.png');
    this._imageStore.load('poly-point', Webgram.imgPath + 'round-control-point.png');
    this._imageStore.load('remove-poly-point', Webgram.imgPath + 'remove-poly-point.png');
    this._imageStore.load('resize-top-left', Webgram.imgPath + 'square-control-point.png');
    this._imageStore.load('resize-top', Webgram.imgPath + 'square-control-point.png');
    this._imageStore.load('resize-top-right', Webgram.imgPath + 'square-control-point.png');
    this._imageStore.load('resize-right', Webgram.imgPath + 'square-control-point.png');
    this._imageStore.load('resize-bottom-right', Webgram.imgPath + 'square-control-point.png');
    this._imageStore.load('resize-bottom', Webgram.imgPath + 'square-control-point.png');
    this._imageStore.load('resize-bottom-left', Webgram.imgPath + 'square-control-point.png');
    this._imageStore.load('resize-left', Webgram.imgPath + 'square-control-point.png');
...
/**
 * Loads the rest of the scripts of the library dynamically.
 * @param {Function} onLoad a callback to be called when
 * the loading is complete
 */
Webgram.load = function (onLoad) {
    var srcList = [
        'utils.js',
        'geometry.js',
        'styles.js',
    ...
    Webgram.Utils.loadScripts(srcList, onLoad);
};
...
Webgram.Utils = Webgram.Namespace('Webgram.Utils', {
     ...
     * completes
     */
    loadScripts: function (srcList, onLoad) {
        function loadFirst() {
            if (srcList.length) {
    ...
    /* flags that indicate the way the webgram library is loaded */

Webgram.singleScript = false;
...
/**
 * The root path (url) to the webgram's images.
 * The value of this field defaults to the 'images/' string
 * appended to {@link Webgram.jsPath}. This could be changed
 * if the webgram images are served from a different path than
 * the JavaScript files.
 * @type String 
 */
Webgram.imgPath = Webgram.jsPath + 'images/';
