...
/**
 * @namespace Contains style classes and related functions
 * that determine how <em>stroke</em>, <em>fill</em> and <em>text</em> are painted on the canvas.
 * This namespace behaves like a factory/store for these styles.
 */
Webgram.Styles = {
    _strokeStyles: {},
    _fillStyles: {},
...
Webgram.Namespace('Webgram.Styles');


/**
 * @class Represents a style used to draw the lines on the canvas.
 ...
 * @param {Array} colors a list of colors to use; if a single color is wanted, it can be passed directly (i.e. not enclosed in an array)
 ...
 */
Webgram.Styles.StrokeStyle = function (lineWidth, lineCap, lineJoin, miterLimit, 
    ...
    /**
     * A list of colors to use. If a single color is used, this field
     * is set directly to that color instead of being wrapped inside an array.
     * @type Array 
     */
    this.colors = colors;
...
Webgram.Styles.StrokeStyle.prototype = {
    /**
...
Webgram.Class('Webgram.Styles.StrokeStyle');


/**
 * @class Represents a style used to fill the shapes on the canvas.
 * Any of the following arguments can be omitted (or passed as <tt>null</tt>),
 * in which case the default values will be used for that attribute.
 * @param {Array} colors a list of colors to use; if a single color is wanted, it can be passed directly (i.e. not enclosed in an array)
 * @param {Webgram.Geometry.Point} gradientPoint1 the start gradient point;
 ...
 * @param {Number} gradientRadius2 the end radius of the radial gradient
 */
Webgram.Styles.FillStyle = function (colors, gradientPoint1, gradientPoint2, gradientRadius1, gradientRadius2) {
    if (!colors) {
        colors = 'white';
    }
...
Webgram.Styles.FillStyle.prototype = {
    /**
...
Webgram.Class('Webgram.Styles.FillStyle');


/**
 * @class Represents a style used to draw the text on the canvas.
 * Any of the following arguments can be omitted (or passed as <tt>null</tt>),
 * in which case the default values will be used for that attribute.
 ...
 * @param {Array} justify an array of two letters; the first one indicates the horizontal
 ...
 */
Webgram.Styles.TextStyle = function (color, font, size, bold, italic, justify) {
    /**
    ...
    /**
     * An array of two letters. The first one indicates the horizontal
     * alignment and is one of <tt>'l'</tt>, <tt>'c'</tt> or <tt>'r'</tt>,
     * for left, center or right alignment, respectively.
     * The second one indicates the vertical
     * alignment and is one of <tt>'t'</tt>, <tt>'c'</tt> or <tt>'b'</tt>,
...
Webgram.Styles.TextStyle.prototype = {
    /**
...
Webgram.Class('Webgram.Styles.TextStyle');
