...
Webgram.Canvas = function (context) {
    ...
    this._strokePattern = null;
    this._strokePatternLength = 0;
    this._strokePatternPos = 0;
};
...
Webgram.Canvas.prototype = {
    ...
    paint: function (strokeStyle, fillStyle, transformSet) {
        ...
        if (strokeStyle) {
            if (strokeStyle.lineWidth > 0) {
                ...
                if (strokeStyle.colors instanceof Array) {
                    ...
                    this.context.strokeStyle = strokeStyle.colors;
                }
            }
            else {
                strokeStyle = null;
        ...
        if (fillStyle) {
            if (fillStyle.colors instanceof Array) {
                ...
                this.context.fillStyle = fillStyle.colors;
            }
        }
    ...
    layoutText: function (text, box, textStyle) {
        ...
        var textX, textY, x, y, top, right, bottom, left;
