...
/**
 * @class A control point that controls a gradient point.
 ...
 */
Webgram.ControlPoints.GradientControlPoint = function (point, siblingPoint, isFirst, style) {
    Webgram.ControlPoints.ProportionalControlPoint.call(this, point);
...
Webgram.ControlPoints.GradientControlPoint.prototype = {
    draw: function () {
    ...
    processMove: function (point, vanillaPoint) {
        Webgram.ControlPoints.ProportionalControlPoint.prototype.processMove.call(this, point, vanillaPoint);
        ...
        if (!this.drawingElement._styleChanged) {
            this.drawingElement._styleChanged = true;
            this.drawingElement.onBeginStyleChange.trigger();
            
            if (this.drawingElement.webgram) {
                this.drawingElement.webgram.saveUndoCheckPoint([this.drawingElement], 'change');
            }
        }
...
Webgram.Class('Webgram.ControlPoints.GradientControlPoint', Webgram.ControlPoints.ProportionalControlPoint);


/**
 * @class A control point that controls a gradient radius.
 * @extends Webgram.ControlPoints.ProportionalControlPoint
 ...
 * @param {Object} either a fill style or a stroke style whose gradient is to be controlled
 */
Webgram.ControlPoints.GradientRadiusControlPoint = function (point, gradientPoint, isFirst, style) {
    Webgram.ControlPoints.ProportionalControlPoint.call(this, point);
...
Webgram.ControlPoints.GradientRadiusControlPoint.prototype = {
    draw: function () {
...
Webgram.Class('Webgram.ControlPoints.GradientRadiusControlPoint', Webgram.ControlPoints.ProportionalControlPoint);
