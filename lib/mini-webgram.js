    ...
    initialize: function MiniWebgram(htmlElement, canvas) {
        ...
        this.rootContainer.drawBackground = function () {
            if (this._fillStyle != null) {
                ...
                var visibleRect = this.webgram.visibleArea.getBoundingRectangle();
                var visiblePoly = this.webgram.visibleArea.transformDirect(visibleRect.getPoly());
                visibleRect = visiblePoly.getBoundingRectangle();
