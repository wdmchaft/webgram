...
/**
 * @class A mini-webgram is a small version of a normal {@link Webgram} instance,
 ...
 */
Webgram.MiniWebgram = function (htmlElement, canvas) {
...
Webgram.MiniWebgram.prototype = {
    ...
    setWidth: function (width) {
        ...
        Webgram.prototype.setWidth.call(this, width);
    ...
    setHeight: function (height) {
        /* we override this method to restore the visible center to (0, 0)*/
        Webgram.prototype.setHeight.call(this, height);
    ...
    handleMouseDown: function (point, button, modifiers) {
        ...
        return Webgram.prototype.handleMouseDown.call(this, point, button, modifiers);
    },
...
Webgram.Class('Webgram.MiniWebgram', Webgram);


Webgram.MiniWebgram._MiniVisibleArea = function () {
    Webgram.DrawingElements.RectangularElement.call(this, ':special:mini-visible-area', -20, -20, 41, 41);
...
Webgram.MiniWebgram._MiniVisibleArea.prototype = {
    draw: function () {
    },
...
Webgram.Class('Webgram.MiniWebgram._MiniVisibleArea', Webgram.DrawingElements.RectangularElement);
