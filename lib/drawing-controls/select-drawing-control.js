...
Webgram.DrawingControls.SelectDrawingControl.prototype = {
    ...
    handleMouseDown: function (point, button, modifiers) {
        if (this.selectedDrawingElement) {
            var result = this.selectedDrawingElement.onMouseDown.trigger(
                    this.selectedDrawingElement.transformInverse(point), button, modifiers);
            if (result) {
                return true;
            }
        }
    ...
    handleMouseUp: function (point, button, modifiers) {
        if (this.selectedDrawingElement) {
            var result = this.selectedDrawingElement.onMouseUp.trigger(
                    this.selectedDrawingElement.transformInverse(point), button, modifiers);
            if (result) {
                return true;
            }
