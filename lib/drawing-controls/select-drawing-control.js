    ...
    handleMouseDown: function (point, button, modifiers) {
        ...
        if (button === 1) {
            ...
            if (this.selectedControlPoint) { /* clicked on a CP */
                this.selectedControlPoint.setFocusType(Webgram.ControlPoint.FOCUS_HOVERED);
...
Webgram.DrawingControls.SelectDrawingControl._MultipleSelectionContainer =
    ...
    setFocusType: function (focusType) {
        ...
        Webgram.DrawingControls.SelectDrawingControl._MultipleSelectionContainer.parent.setFocusType.call(this, focusType);
    },
