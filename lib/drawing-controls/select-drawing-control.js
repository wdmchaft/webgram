...
Webgram.DrawingControls.SelectDrawingControl = 
    ...
    doMoveAction: function (direction, fine) {
        ...
        drawingElement.setLocation(location);
    ...
    handleMouseDown: function (point, button, modifiers) {
        ...
        if (this.hoveredDrawingElement && this.hoveredDrawingElement.pointInside(point)) {
...
Webgram.DrawingControls.SelectDrawingControl._MultipleSelectionContainer =
    ...
    initialize: function _MultipleSelectionContainer(x, y, width, height) {
        this.callSuper(':special:multiple-selection-container', x, y, width, height);
