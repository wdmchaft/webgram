...
Webgram.DrawingControls.SelectDrawingControl = 
        ...
        if (this._panMouseDownPoint) { /* used for panning */
            ...
            if (this.selectedControlPoint) { /* execute the control point's action */
                ...
                if (this.selectedDrawingElement.isMoveEnabled() && this.selectedDrawingElement._mouseDownPoint) { /* move the whole drawing element */
                    ...
                    this.selectedDrawingElement._setLocation(new Webgram.Geometry.Point(x, y), true);
    ...
    _finishMultipleSelection: function (mouseDownPoint) {
        ...
        this.getWebgram().disableUndoCheckPoints();
        ...
        this.getWebgram().enableUndoCheckPoints();
        ...
        else if (this._msGroup._drawingElements.length === 1 /* && drawingElements.length === 0 */) {
            /* a single selected element, select it directly instead of adding to multiple selection,
             * and destroy the existing multiple selection group */
            
            var drawingElement = this._msGroup._drawingElements[0];
...
Webgram.DrawingControls.SelectDrawingControl._MultipleSelectionGroup =
    ...
    initialize: function _MultipleSelectionGroup(x, y) {
        ...
        this.onIndexChange.bind(function () {
            ...
            // TODO trigger the index change events on children
        });
        
//        /* we bind the following handlers because we need
//         * the corresponding events triggered on the children */
//        
...
//        });
    ...
    handleMouseDown: function (point, button, modifiers) {
        ...
        if (hoveredDrawingElement && modifiers.shift && (this.getRotationAngle() === 0)) { // TODO rotation angle condition needed?
    ...
    finishShapeEvents: function (force) {
         ...
         * on the multiple selection group, but we want them triggered on the children */
    ...
    _addDrawingElement: function (drawingElement, where, triggerEvents) {
        ...
        Webgram.DrawingControls.SelectDrawingControl._MultipleSelectionGroup.parent._addDrawingElement.call(this, drawingElement, where, triggerEvents);
    ...
    _remDrawingElement: function (drawingElement, triggerEvents) {
        ...
        Webgram.DrawingControls.SelectDrawingControl._MultipleSelectionGroup.parent._remDrawingElement.call(this, drawingElement, triggerEvents);
...
//    _bindGeometryChangeHandlers: function (drawingElement) { TODO bye bye
//        Webgram.DrawingControls.SelectDrawingControl._MultipleSelectionGroup.parent._bindGeometryChangeHandlers.call(this, drawingElement);
//        
////        drawingElement.onRestore.bind(function () {
////            if (this.webgram && !this.webgram.userInteraction()) {
////                Webgram.DrawingElements.GroupElement._whenGeometryChanged.call(this);
////            }
////        });
//    },
    
//    _unbindGeometryChangeHandlers: function (drawingElement) { TODO bye bye
//        Webgram.DrawingControls.SelectDrawingControl._MultipleSelectionGroup.parent._unbindGeometryChangeHandlers.call(this, drawingElement);
//        
//        //drawingElement.onRestore.unbind(Webgram.DrawingElements.GroupElement._whenGeometryChanged);
//    },
    ...
    _setWebgram: function (webgram) {
        Webgram.DrawingControls.SelectDrawingControl._MultipleSelectionGroup.parent._setWebgram.call(this, webgram);
    ...
    _clearWebgram: function () {
        ...
        Webgram.DrawingControls.SelectDrawingControl._MultipleSelectionGroup.parent._clearWebgram.call(this);
    }
}, 
