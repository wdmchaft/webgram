...
Webgram.DrawingControls.SelectDrawingControl = 
    ...
    doDuplicateAction: function () {
        ...
        if (drawingElements.length > 1) { /* multiple selection */
            ...
            this.setSelectedDrawingElements(drawingElements);
            drawingElement = this._msGroup;
        }
        else {
            drawingElement = drawingElements[0].duplicate(true);
        ...
        if (location != null && drawingElement != null) {
            drawingElement.setLocation(location.getTranslated(mainGridSizeX, mainGridSizeY));
        }
    ...
    _markMultipleSelected: function (drawingElements) {
        ...
        msBoundingRectangle = this._msGroup.getBoundingRectangle(true);
...
Webgram.DrawingControls.SelectDrawingControl._MultipleSelectionGroup =
    ...
    initialize: function _MultipleSelectionGroup(x, y) {
        Webgram.DrawingControls.SelectDrawingControl._MultipleSelectionGroup.parentClass.call(this, ':special:multiple-selection-group');
