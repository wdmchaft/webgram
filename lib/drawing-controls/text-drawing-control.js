...
Webgram.DrawingControls.TextDrawingControl.prototype = {
    ...
    _setText: function (text) {
        if (this._drawingElement.webgram) {
    ...
    _getLineCol: function () {
        ...
        var i, colNo = 0, lineNo = 0, lineCount = 0;
        ...
        return {
            ...
            colCount: textLayout[lineNo].text.length,
            layout: textLayout,
            text: text
        };
    },
...
Webgram.DrawingControls.TextDrawingControl._TextInputArea.prototype = {
    ...
    drawCursor: function () {
        ...
        var strokeStyle = this.getStrokeStyle().replace({colors: [textStyle.color]});
    ...
    pointInside: function (point) {
        ...
        return this.rotateDirect(rect.getPoly()).pointInside(point);
    }
};
