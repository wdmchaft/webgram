...
Webgram.DrawingControls.CreateDrawingControl =
        Webgram.DrawingControl.extend( /** @lends Webgram.DrawingControls.CreateDrawingControl.prototype */ {
            
    /**
     * A drawing control used to interactively create drawing elements on the canvas.
     * @constructs Webgram.DrawingControls.CreateDrawingControl
     ...
     */
    initialize: function CreateDrawingControl(rootContainer) {
        Webgram.DrawingControls.CreateDrawingControl.parentClass.call(this, rootContainer);
     ...
     * @param {Function} initializer an optional function to initialize the newly created object;
     * this function, if supplied, will be called with the drawing element as <tt>this</tt>,
     * as soon as the element is created using the constructor
     */
    setDrawingElementClass: function (drawingElementClass, initializer) {
    ...
    finish: function () {
        ...
        if (drawingElement.endCreate()) {
            ...
            drawingElement.onAdd.trigger(this.rootContainer);
            ...
            drawingElement.onCreate.trigger();
        }
        else {
    ...
    handleMouseDown: function (point, button, modifiers) {
        ...
        if (!this.drawingElement) { /* first click */
            ...
            if (this.initializer) {
                this.initializer.call(this.drawingElement);
            }
            this.drawingElement.setFocus(Webgram.DrawingElement.FOCUS_SELECTED);
            ...
            if (modifiers.shift) {
                this.drawingElement.activateShift();
            }
    ...
    handleKeyUp: function (key, modifiers) {
        if (this.drawingElement) {
            ...
            if (key === 16) { /* shift */
                this.drawingElement.deactivateShift();
                this.invalidate();
    ...
    handleBlur: function () {
         ...
         * we call deactivateShift on the current element if it was previously enabled */
        
        if (this.drawingElement != null && this.drawingElement.isShiftActive()) {
            this.drawingElement.deactivateShift();
