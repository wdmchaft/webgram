...
Webgram.DrawingControls.CreateDrawingControl.prototype = {
    ...
    handleMouseUp: function (point, button, modifiers) {
        ...
        if (this.drawingElement != null) {
            /* this will trigger an onShapeChange event on the DE,
             * whenever the mouse button is released during the creation process */
            this.drawingElement.triggerShapeChange();
        }
