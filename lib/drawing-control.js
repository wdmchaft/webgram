...
/**
 * @class This is the base class for all drawing controls.
 ...
 */
Webgram.DrawingControl = function (rootContainer) {
    /**
...
Webgram.DrawingControl.prototype = {
    /**
    ...
    invalidateDrawing: function (mini) {
        this.rootContainer.webgram.invalidateDrawing();
        if (mini) {
            this.rootContainer.webgram.invalidateDrawingMini();
        }
    },
    ...
    activate: function () {
        ...
        /* issue an initial mouse move on the newly activated DC */
...
Webgram.Class('Webgram.DrawingControl');
