...
Webgram.ControlPoint.prototype = {
    ...
    /**
     * Determines if a given <tt>point</tt> (relative to the element)
     ...
     * corresponding fields of the drawing element based on <tt>point</tt> and <tt>vanillaPoint</tt> arguments.<br><br>
     * <em>(must be overridden)</em>
