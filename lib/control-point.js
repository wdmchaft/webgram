...
Webgram.ControlPoint = Webgram.Class.extend( /** @lends Webgram.ControlPoint.prototype */ {
    ...
    initialize: function ControlPoint() {
        ...
        this._anchor = null;
        this._focus = Webgram.ControlPoint.FOCUS_NONE;
         ...
         * Handlers receive the following arguments: <tt>(anchor)</tt>.
         * @see Webgram.ControlPoint#update 
         * @type Webgram.Event
         */
        this.onUpdate = new Webgram.Event('update', this); /* (anchor) */
         ...
         * by a call to {@link Webgram.ControlPoint#setFocus}.<br>
         * Handlers receive no arguments. 
         * @type Webgram.Event
         */
     ...
     * @param focus {Number} one of the Webgram.ControlPoint.FOCUS_* values
     */
    ...
    drawLine: function (point1, point2) {
        var anchor = this.getAnchor(true);
    ...
    drawText: function (text, box, rotationAngle, textStyle) {
        box = box || new Webgram.Geometry.Rectangle(-this.radius, -this.radius, this.radius, this.radius);
        rotationAngle = rotationAngle || 0;
        ...
        this.drawingElement._parent.drawText(text, box, rotationAngle, textStyle);
    },
    ...
    /**
     * Returns the default text style used by this control point.
     * @returns {Webgram.Styles.TextStyle} the default text style of this control point
     */
    ...
    /**
     * Sets the default text style used by this control point.
     * @param {Webgram.Styles.TextStyle} textStyle the default text style to be used by this control point
     */
     ...
     * is inside of this control point or not.<br><br>
    ...
    pointInside: function (point) {
        ...
        var anchor = this.getAnchor(false);
     ...
     * The coordinates of this anchor are relative to the element,
     * unless the <tt>transformed</tt> parameter is set to <tt>true</tt>,
     * in which case the coordinates are relative to the parent's element.
     * If the anchor is <tt>null</tt> (read: invalid), this method calls
     ...
     * <em>(should not be overridden)</em>
     * @param {Boolean} transformed set to <tt>true</tt> to return the transformed anchor
     * @returns {Webgram.Geometry.Point} the value of the anchor
     */
    getAnchor: function (transformed) {
        if (!this._anchor) {
            this.update(false);
        }
        
        if (transformed) {
            return this.drawingElement.transformDirect(this._anchor);
        }
        else {
            return this._anchor;
        }
     ...
     * @param {Boolean} snap set to <tt>true</tt> to invoke snapping, <tt>false</tt> otherwise
     */
    ...
    move: function (point) {
        ...
        this.processMove(point, vanillaPoint, true);
    ...
    update: function () {
        ...
        if (oldAnchor == null || !this._anchor.equals(oldAnchor)) {
            this.onUpdate.trigger(anchor);
        }
        
        /* onUpdate might have invalidated the anchor */
        this._anchor = anchor;
    },
