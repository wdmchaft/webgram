...
Webgram.ControlPoint.prototype = {
     ...
     * its area. This radius does not change with the zoom level.
     * @returns {Number} the radius of this control point
     */
    getRadius: function () {
        return this._radius;
    },
    ...
    /**
     * Sets the radius of this control point.
     * @param {Number} radius the new radius of this control point
     */
    ...
    /**
     * This tells whether the control point is drawn rotated
     * according to the drawing element's rotation angle or not.
     */
    ...
    /**
     * Enables or disables the rotation of this control point
     * along with the drawing element.
     * @param {Boolean} enabled set to <tt>true</tt> to enable rotation,
    ...
    pointInside: function (point) {
        var radius = this.getRadius() / this.getZoomFactor();
