...
Webgram.prototype = {
    ...
    purgeUndoCheckPoints: function (drawingElement) {
        for (var i = 0; i < this._undoCheckPoints.length; i++) {
            ...
            for (var j = 0; j < checkPoint.elementInfoList; j++) {
                var info = checkPoint.elementInfoList[j];
                if (info.drawingElement === drawingElement ||
                    info.parent === drawingElement) {
    ...
    userInteraction: function () {
        return this._keyboardEvent || this._mouseEvent || this._focusEvent;
    },
