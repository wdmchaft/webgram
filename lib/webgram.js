...
Webgram.Class = function (fullName, parentClass, instanceMembers, classMembers) {
    ...
    if (parentClass) {
        ...
        newPrototype = this._Inherit(instanceMembers ? instanceMembers : {});
    }
    ...
    /* add a reference to the super class */
    newPrototype.__super__ = (parentClass && parentClass.prototype) || null;
