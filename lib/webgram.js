...
Webgram.Class = (function () {
    ...
    Class.extend = function (instanceMembers, classMembers) {
        ...
        var constructor = instanceMembers.initialize;
        
        if (constructor == null) { /* constructor not supplied, adding a default one */
        ...
        constructor = function () {
            var tmp = this.super;
            this.super = parentConstructor;
            oldConstructor.apply(this, arguments);
            this.super = tmp;
        };
        
        /* create the new prototype */
        var newPrototype = inherit(parentConstructor.prototype);
        ...
        for (var key in instanceMembers) {
            if (instanceMembers.hasOwnProperty(key)) {
                ...
                if (typeof instanceMember === 'function' && typeof parentConstructor.prototype[key] === "function") {
                    /* wrap the method so that the super method is properly set */
                    newPrototype[key] = function (func, key) {
                        return function () {
                            var tmp = this.super;
                            this.super = parentConstructor.prototype[key];
        ...
        constructor.augment = Class.augment;
     ...
     * classes inherited with the {@link Webgram.Class.extends} function, defined above.
     * @memberof Webgram.Class
    ...
    /* some utilities that must be available directly from this script file */
