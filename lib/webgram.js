...
Webgram = function (htmlElement, canvas, settings) {
     ...
     * @type Webgram.Event
     */
    this.onUndoAction = new Webgram.Event('undo action', this); /* (drawingElements, operation, byKeyboard) */
     ...
     * @type Webgram.Event
     */
    this.onRedoAction = new Webgram.Event('redo action', this); /* (drawingElements, operation, byKeyboard) */
...
Webgram.prototype = {
    ...
    saveUndoCheckPoint: function (drawingElements, operation) {
        ...
        for (var i = 0; i < drawingElements.length; i++) {
            ...
            /* don't add change check points for elements being created */
            if (operation === 'change' && drawingElement.isCreating()) {
                continue;
            }
