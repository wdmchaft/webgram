...
// TODO bye bye
/**
 * Contains the classes needed to implement <em>connectors</em> in webgram.
...
Webgram.Connectors.Connector = 
        Webgram.DrawingElements.PolyElement.extend( /** @lends Webgram.Connectors.Connector.prototype */ {
     ...
     */
    initialize: function Connector(id, points) {
    ...
    draw: function () {
        this.drawPoly(this.getShape(), false);
    ...
    snapExternally: function (index, point, fixedPoints, rotationAngle, center) {
        ...
        Webgram.DrawingElements.PolyElement.prototype.snapExternally.call(this, index, point, fixedPoints, rotationAngle, center);
    },
    ...
    _setCenter: function (center, snap) {
        ...
        if (!snap) {
            return this.callSuper(center, snap);
        }
        ...
        if (endPoint) { /* at least an end point is connected */
            ...
            var dist = currentCenter.getDistanceTo(center);
    ...
    continueCreate: function (point, size, mouseDown, click) {
        ...
        return this.callSuper(point, size, mouseDown, click);
    },
    ...
    _snapToSockets: function (index, point, fixedPoints, rotationAngle, center) {
        ...
        if (socket) {
            return socket.getAnchor(true).getRotated(-rotationAngle, center);
        }
    },
    ...
    _setRotationAngle: function (angle, triggerEvents) {
        ...
        this.callSuper(angle, triggerEvents);
    },
