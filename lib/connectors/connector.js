...
Webgram.Connectors.Connector.prototype = {
    ...
    continueCreate: function (point, size, mouseDown, click) {
        ...
        var count = this.shape.points.length;
    ...
    toJson: function() {
        /* we override this method because we need to add the
         * "connected" information to the json structure */
        var json = Webgram.DrawingElements.PolyElement.prototype.toJson.call(this);
        
        json.connections = this._connectionsToJson();
        
        return json;
    },
    
    fromJson: function (json) {
        /* we override this method because we need to use the
         * "connected" information to from json structure */
        
        Webgram.DrawingElements.PolyElement.prototype.fromJson.call(this, json);
        
        this._connectionsFromJson(json.connections);
    },
    ...
    _snapToSockets: function (index, point, fixedPoints, rotationAngle, center) {
        ...
        /* if the endpoint is over a socket, 
    ...
    _setRotationAngle: function (angle) {
        ...
        Webgram.DrawingElements.PolyElement.prototype._setRotationAngle.call(this, angle);
    },
    ...
    _connectionsToJson: function () {
        ...
        for (var i = 0; i < endPoints.length; i++) {
            ...
            connections.push({
                'elementId': drawingElement.getId(),
    ...
    _connectionsFromJson: function (json) {
        ...
        for (i = 0; i < json.length; i++) {
            ...
            key = connection.elementId + '|' + connection.endPointIndex + '|' + connection.socketIndex;
            ...
            drawingElement = this.webgram.getDrawingElementById(connection.elementId);
