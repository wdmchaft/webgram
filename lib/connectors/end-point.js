...
Webgram.Connectors.EndPoint =
        Webgram.DrawingElements.PolyElement.PolyControlPoint.extend( /** @lends Webgram.Connectors.EndPoint.prototype */ {

    /**
     * A special poly control point that remains connected to sockets.
     ...
     */
    initialize: function EndPoint(polyPointIndex) {
        this.callSuper(polyPointIndex);
    ...
    _checkConnect: function () {
        var hoveredSocket = this._getHoveredSocket(this.getAnchor(true));
        if (hoveredSocket) {
