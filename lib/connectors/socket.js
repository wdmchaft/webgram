...
Webgram.Connectors.Socket =
    ...
    connect: function (endPoint) {
        ...
        var point = endPoint.drawingElement.transformInverse(this.getAnchor());
        endPoint.processMove(point);// TODO needed?
        ...
        endPoint.drawingElement.addDependency(this.drawingElement);
