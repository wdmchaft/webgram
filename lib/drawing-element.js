...
//                    }
            ...
            var rotatedShape = this.rotateDirect(this.getShape());
    ...
    getSnappingPoints: function () {
        var points = Webgram.Utils.clone(this.rotateDirect(this.getShape()).points);
    ...
    saveParentRelativePosition: function () {
        ...
        for (var i = 0; i < this.getShape().points.length; i++) {
            var point = this.getShapePoint(i);
