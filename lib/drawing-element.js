...
Webgram.DrawingElement = function (id, points) {
     ...
     */
    this.rotationCenter = new Webgram.Geometry.Point(0, 0); // TODO this should be private
...
Webgram.DrawingElement.prototype = {
    ...
    beginStyleChange: function () {
        if (!this._styleChanged) {
            ...
            if (this.webgram && !this.isCreating()) {
     ...
     * <em>(should not be overridden)</em>
     * @param index {Number} the index of the shape point to be modified
     * @param point {Webgram.Geometry.Point} the new desired position of the point
     */
    setTransformedShapePoint: function (index, point) {
        this._setTransformedShapePoint(index, point, true);
    },
...
//                    }
    ...
    restoreParentRelativePosition: function () {
        ...
        for (var i = 0; i < this._parentRelativePositions.length; i++) {
            ...
            this.setShapePoint(i, point);
        }
        
        var newCenter = this.getShape().getBoundingRectangle().getCenter();
        this.setShape(this.getShape().getRotated(-this.getRotationAngle(), newCenter));
    },
     ...
     */
    addDependency: function (drawingElement) {
        drawingElement._dependentDrawingElements.push(this);
    },
    ...
    remDependency: function (drawingElement) {
        drawingElement._dependentDrawingElements.splice(
                Webgram.Utils.indexOf(drawingElement._dependentDrawingElements, this), 1);
    },
    ...
    getDependentDrawingElements: function () {
        var dependentElements = this._dependentDrawingElements.slice();
        var drawingElement;
        var i, j;
    ...
    _enterContainerElement: function (containerElement, triggerEvents) {
        ...
        this.saveParentRelativePosition();
        this.invalidate(); // TODO is this call needed here?
    },
