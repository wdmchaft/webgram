...
Webgram.DrawingElement = Webgram.Class.extend( /** @lends Webgram.DrawingElement.prototype */ {
    ...
    /**
     * Returns the absolute location of this element.
    ...
    getAbsLocation: function () {
        ...
        while (drawingElement._parent) {
            location = drawingElement._parent.transformDirect(location);
    ...
    /**
     * Returns the absolute rotation angle of this element.
    ...
    getAbsRotationAngle: function () {
        ...
        var drawingElement = this;
        while (drawingElement._parent) {
            rotationAngle = drawingElement._parent.getRotationAngle() + drawingElement._parent.getFlippedAngle(rotationAngle);
