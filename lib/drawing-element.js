...
Webgram.DrawingElement = Webgram.Class.extend( /** @lends Webgram.DrawingElement.prototype */ {
     ...
     * no snapping is performed and the function returns <tt>null</tt>.<br><br>
     * <em>(could be overridden)</em>
     * @param {Wegram.Geometry.Point} point the point to snap
     * @returns TODO jsdoc me
     */
    ...
    _getSnappedLocation: function () {
        ...
        var closestPointX = null;
        var closestPointY = null;
        var xSnapFeedback = false;
        var ySnapFeedback = false;
        ...
        for (var i = 0; i < snappingPoints.length; i++) {
            ...
            if (snappingPoint.equals(zero)) {
                /* the origin is not included in the snapping algorithm */
            ...
            if (!snapped) {
                snapped = this._snapToGrid(snappingPoint);
                snappedToGrid = true;
            }
            ...
            if (snapped instanceof Webgram.Geometry.Point) {
                ...
                /* no else, no oblique snap line here */
            }
        }
        
        this.setSnapVisualFeedback({
            type: 'linear',
            x: xSnapFeedback ? closestPointX : null,
            y: ySnapFeedback ? closestPointY : null,
        });
