...
Webgram.DrawingElement = Webgram.Class.extend( /** @lends Webgram.DrawingElement.prototype */ {
    ...
    initialize: function DrawingElement(id, points) {
        ...
        /**
         * An event that is triggered when the element's location begins to change.<br>
         * Handlers receive no arguments. 
         * @type Webgram.Event
         */
        ...
        /**
         * An event that is triggered whenever one of the following begins to change:<ul>
         *  <li>shape</li>
         *  <li>location, rotation angle, flip state</li>
        ...
        /**
         * An event that is triggered whenever one of the following changes:<ul>
         *  <li>shape</li>
         *  <li>location, rotation angle, flip state</li>
         *  <li>stroke style, fill style, text style</li>
         *  <li>z-index</li></ul>
        ...
        /**
         * An event that is triggered whenever one of the following finishes to change:<ul>
         *  <li>shape</li>
         *  <li>location, rotation angle, flip state</li>
         *  <li>stroke style, fill style, text style</li>
         *  <li>z-index</li></ul>
    ...
    /**
     * Call this method after the change of the stroke style of this element is done.
     */
    ...
    _setFillStyle: function (fillStyle) {
        ...
        this.onFillStyleChange.trigger();
    ...
    /**
     * Call this method after the change of the fill style of this element is done.
     */
...
//    },
    ...
    _enterContainerElement: function (containerElement, triggerEvents) {
        ...
        this._setLocation(this.getLocation().getTranslated(-blockCenter.x, -blockCenter.y), false);
