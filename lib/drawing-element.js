...
Webgram.DrawingElement = Webgram.Class.extend( /** @lends Webgram.DrawingElement.prototype */ {
     ...
     */
    initialize: function DrawingElement(id, points) {
        if (points == null) {
            points = [];
        }
         ...
         * in order to be consistent, i.e. to be drawn properly. 
        ...
        /**
         * An event that is triggered when the element's center begins to change.<br>
         * Handlers receive no arguments. 
         * @type Webgram.Event
         */
        ...
        /**
         * An event that is triggered when the element finishes to move.<br>
         * Handlers receive no arguments. 
         * @type Webgram.Event
         */
        ...
        /**
         * An event that is triggered when the user begins to change the stroke style.<br>
         * Handlers receive no arguments. 
         * @type Webgram.Event
         */
        this.onBeginStrokeStyleChange = new Webgram.Event('begin stroke style change', this); /* () */

        /**
         * An event that is triggered whenever the stroke style changes.<br>
         * Handlers receive no arguments.
         * @type Webgram.Event
         */
        this.onStrokeStyleChange = new Webgram.Event('stroke style change', this); /* () */

        /**
         * An event that is triggered when the stroke style finishes to change.<br>
         * Handlers receive no arguments. 
         * @type Webgram.Event
         */
        this.onEndStrokeStyleChange = new Webgram.Event('end stroke style change', this); /* () */

        /**
         * An event that is triggered when the user begins to change the fill style.<br>
         * Handlers receive no arguments. 
         * @type Webgram.Event
         */
        this.onBeginFillStyleChange = new Webgram.Event('begin fill style change', this); /* () */

        /**
         * An event that is triggered whenever the fill style changes.<br>
         * Handlers receive no arguments.
         * @type Webgram.Event
         */
        this.onFillStyleChange = new Webgram.Event('fill style change', this); /* () */

        /**
         * An event that is triggered when the fill style finishes to change.<br>
         * Handlers receive no arguments. 
         * @type Webgram.Event
         */
        this.onEndFillStyleChange = new Webgram.Event('end fill style change', this); /* () */

        /**
         * An event that is triggered whenever the text style changes.<br>
         * Handlers receive no arguments.
         * @type Webgram.Event
         */
        this.onTextStyleChange = new Webgram.Event('text style change', this); /* () */

        /**
         * An event that is triggered whenever one of the following attributes begins to change:<ul>
         *  <li>shape</li>
         *  <li>center, rotation angle, flip state</li>
         *  <li>stroke style, fill style, text style</li>
         *  <li>z-index</li></ul>
         * In addition to these, the beginning to change of any additional attributes that contribute
         * to the json data of the element should trigger this event.<br>
         * Handlers receive the following arguments: <tt>(attribute)</tt>.
         * @type Webgram.Event
         */
        this.onBeginChange = new Webgram.Event('begin change', this); /* (attribute) */
        
        /**
         * An event that is triggered whenever one of the following attributes changes:<ul>
         *  <li>shape</li>
         *  <li>center, rotation angle, flip state</li>
         *  <li>stroke style, fill style, text style</li>
         *  <li>z-index</li></ul>
         * In addition to these, the changing of any additional attributes that contribute
         * to the json data of the element should trigger this event.<br>
         * Handlers receive the following arguments: <tt>(attribute)</tt>.
         * @type Webgram.Event
         */
        this.onChange = new Webgram.Event('change', this); /* (attribute) */
        
        /**
         * An event that is triggered whenever one of the following attributes finishes to change:<ul>
         *  <li>shape</li>
         *  <li>center, rotation angle, flip state</li>
         *  <li>stroke style, fill style, text style</li>
         *  <li>z-index</li></ul>
         * In addition to these, the finishing to change of any additional attributes that contribute
         * to the json data of the element should trigger this event.
         * This event is linked with the
         * more general {@link Webgram#onDrawingElementChange} event<br>
         * Handlers receive the following arguments: <tt>(attribute)</tt>.
         * @type Webgram.Event
         */
        this.onEndChange = new Webgram.Event('end change', this); /* (attribute) */
        ...
        this.onBeginMove.bind(function () {
            this.onBeginChange.trigger('center');
        });
        this.onBeginRotate.bind(function () {
            this.onBeginChange.trigger('rotationAngle');
        });
        this.onBeginStrokeStyleChange.bind(function () {
            this.onBeginChange.trigger('strokeStyle');
        });
        this.onBeginFillStyleChange.bind(function () {
            this.onBeginChange.trigger('fillStyle');
        });
        ...
        this.onEndMove.bind(function () {
            this.onEndChange.trigger('center');
        });
        this.onEndRotate.bind(function () {
            this.onEndChange.trigger('rotationAngle');
        });
        this.onEndStrokeStyleChange.bind(function () {
            this.onEndChange.trigger('strokeStyle');
        });
        this.onEndFillStyleChange.bind(function () {
            this.onEndChange.trigger('fillStyle');
        });
        ...
        this.onMove.bind(function () {
            this.onChange.trigger('center');
        });
        this.onRotate.bind(function () {
            this.onChange.trigger('rotationAngle');
        });
        this.onStrokeStyleChange.bind(function () {
            this.onChange.trigger('strokeStyle');
        });
        this.onFillStyleChange.bind(function () {
            this.onChange.trigger('fillStyle');
        });
        this.onTextStyleChange.bind(function () {
            this.onChange.trigger('textStyle');
        });
        ...
        /* shape */
        this._shape = new Webgram.Geometry.Poly(points);
        this._shapeChanged = false;
        
        /* transforms */
        this._center = new Webgram.Geometry.Point(0, 0);
        ...
        /* compute the base rectangle, to avoid an initial shape change event */
        this._baseRectangle = this._computeBaseRectangle();
    ...
    /**
     * Determines the untransformed rectangle to be drawn as decoration.
    ...
    /**
     * Returns the shape polygon of this drawing element.<br>
     * Each drawing element has a set of one or more points that serve as anchors and often give its exact shape.
     * We call the polygon made of these points the <em>shape</em> of the element.<br>
     * Shape points are untransformed (relative to the center of the element).<br>
     * @param {Boolean} transformed set to <tt>true</tt> to return the transformed shape (relative to the parent)
     * @see Webgram.DrawingElement#getShapePoint
     * @returns {Webgram.Geometry.Poly} the shape of this element
     */
    getShape: function (transformed) {
        if (transformed) {
            return this.transformDirect(this._shape);
        }
        else {
            return this._shape;
        }
    ...
    /**
     * Sets the shape polygon of this drawing element.<br>
     * Each drawing element has a set of one or more points that serve as anchors and often give its exact shape.
     * We call the polygon made of these points the <em>shape</em> of the element.<br>
     * Shape points are untransformed (relative to the center of the element).<br>
     * In most cases you don't really have to deal with this field, but rather use {@link Webgram.DrawingElement#setShapePoint}.<br>
     * @param {Webgram.Geometry.Poly} shape the new shape of the element
     */
    ...
    /**
     * Returns a point of the shape of this element.
     * @param {Number} index the index of the point to return
     * @param {Boolean} transformed set to <tt>true</tt> to return the transformed shape point
     * @see Webgram.DrawingElement#getShape
     * @returns {Webgram.Geometry.Point} the point
     */
    getShapePoint: function (index, transformed) {
        if (transformed) {
            return this.transformDirect(this._shape.points[index]);
        }
        else {
            return this._shape.points[index];
        }
    ...
    /**
     * Sets a point of the shape polygon of this element.
     * @param {Number} index the index of the point to set
     * @param {Webgram.Geometry.Point} point the new point
     * @param {Boolean} transformed set to <tt>true</tt> if the <tt>point</tt>
     * represents the transformed shape point, <tt>false</tt> otherwise
     * @see Webgram.DrawingElement#setShape
     */
    setShapePoint: function (index, point, transformed) {
        this._setShapePoint(index, point, transformed, false);
        
        this.finishShapeEvents();
    },
    
    _setShapePoint: function (index, point, transformed, snap) {
        this.beginShapeChange();
        ...
        if (transformed) {
            ...
            this._shape.points[index] = point;
        }
        
        this.onShapeChange.trigger();
        
        if (snap) {
            this.snap(index); // TODO proper snapping
        }
    ...
    /**
     * Returns the minimal constraint of a given shape point.
     * The point cannot get closer to the center than the result
     * of this method.<br><br>
     * <em>(could be overridden)</em>
     * @param {Number} index the index of the shape point
     * @returns {Webgram.Geometry.Point} the minimal constraint point,
     * relative to this element, or <tt>null</tt> if no constraint is imposed
     */
    ...
    /**
     * Returns the maximal constraint of a given shape point.
     * The point cannot get farther from the center than
     * the result of this method.<br><br>
     * <em>(could be overridden)</em>
     * @param {Number} index the index of the shape point
     * @returns {Webgram.Geometry.Point} the maximal constraint point,
     * relative to this element, or <tt>null</tt> if no constraint is imposed
     */
     ...
     * @returns {Webgram.Geometry.Point} the constrained point
     */
    applyShapePointConstraints: function (index, point) {
        return point;
    },
    ...
    _applyShapePointConstraints: function (index, point, fixedPoints, rotationAngle, center) {
        ...
        var minPoint = this.getMinShapePoint(index);
        var maxPoint = this.getMaxShapePoint(index);

        var fixedSumX = 0, fixedSumY = 0;
        for (var i = 0; i < fixedPoints.length; i++) {
            fixedSumX += fixedPoints[i].x;
            fixedSumY += fixedPoints[i].y;
        }
        
        /* apply the minimum constraints */
        if (minPoint != null) {
            var minX = ((fixedPoints.length + 1) * minPoint.x + fixedSumX) / fixedPoints.length;
            var minY = ((fixedPoints.length + 1) * minPoint.y + fixedSumY) / fixedPoints.length;
            
            var tempPoints = fixedPoints.slice(); tempPoints.push(new Webgram.Geometry.Point(minX, minY));
            var tempCenter = new Webgram.Geometry.Poly(tempPoints).getCenter();
            
            point = point.getTranslated(-tempCenter.x, -tempCenter.y);
            minX -= tempCenter.x;
            minY -= tempCenter.y;
            
            if ((minX < 0 && minX < point.x) || (minX > 0 && minX > point.x)) {
                point = new Webgram.Geometry.Point(minX, point.y);
            }
            if ((minY < 0 && minY < point.y) || (minY > 0 && minY > point.y)) {
                point = new Webgram.Geometry.Point(point.x, minY);
            }
        ...
        if (maxPoint != null) {
            var maxX = ((fixedPoints.length + 1) * maxPoint.x + fixedSumX) / fixedPoints.length;
            var maxY = ((fixedPoints.length + 1) * maxPoint.y + fixedSumY) / fixedPoints.length;
            
            /*if ((maxX < 0 && maxX > point.x) || (maxX > 0 && maxX < point.x)) {
                point = new Webgram.Geometry.Point(maxX, point.y);
            }
            if ((maxY < 0 && maxY > point.y) || (maxY > 0 && maxY < point.y)) {
                point = new Webgram.Geometry.Point(point.x, maxY);
            }*/
    ...
    /**
     * Call this method before changing the shape of this element.
     */
    ...
    /**
     * A drawing element uses three events to signal the change of the shape:
     * {@link Webgram.DrawingElement#onBeginShapeChange},
     * {@link Webgram.DrawingElement#onShapeChange} and 
     * {@link Webgram.DrawingElement#onEndShapeChange}.
     * This method assures a successive and uniform triggering
     * of the three events. It is automatically invoked when
     * one of the shape points is modified via the library-provided methods.
     */
    ...
    _setCenter: function (center, snap) {
        var oldCenter = this._center;
        
        this.beginMove();
        this._center = center;
        this.onMove.trigger(center.x - oldCenter.x, center.y - oldCenter.y);
    ...
    /**
     * Call this method before changing the center of this element.
     */
    beginMove: function () {
    ...
    /**
     * A drawing element uses three events to signal the change of the center:
     * {@link Webgram.DrawingElement#onBeginMove},
     * {@link Webgram.DrawingElement#onMove} and 
     * {@link Webgram.DrawingElement#onEndMove}.
     * This method assures a successive and uniform triggering
     * of the three events. It is automatically invoked when
     * the center is modified via the library-provided methods.
     */
...
//            if (this._parent != null) { TODO is this needed?
...
//            }
    ...
    /**
     * A drawing element uses three events to signal the change of the rotation angle:
     * {@link Webgram.DrawingElement#onBeginRotate},
     * {@link Webgram.DrawingElement#onRotate} and 
     * {@link Webgram.DrawingElement#onEndRotate}.
     * This method assures a successive and uniform triggering
     * of the three events. It is automatically invoked when
     * the rotation angle is modified via the library-provided methods.
     */
    ...
    /**
     * Flips the angle according to the flipping state
     ...
     * The rotation uses the center of the drawing element, unless the <tt>center</tt>
    ...
    setStrokeStyle: function (strokeStyle) {
        ...
        this.finishStrokeStyleEvents();
    },

    _setStrokeStyle: function (strokeStyle) {
        this.beginStrokeStyleChange();
        ...
        this.onStrokeStyleChange.trigger();
    ...
    /**
     * Call this method before changing the stroke style of this element.
     */
    beginStrokeStyleChange: function () {
        if (!this._strokeStyleChanged) {
            this._strokeStyleChanged = true;
            this.onBeginStrokeStyleChange.trigger();
    ...
    /**
     * A drawing element uses three events to signal the change of the stroke style:
     * {@link Webgram.DrawingElement#onBeginStrokeStyleChange},
     * {@link Webgram.DrawingElement#onStrokeStyleChange} and 
     * {@link Webgram.DrawingElement#onEndStrokeStyleChange}.
     * This method assures a successive and uniform triggering
     * of the three events. It is automatically invoked when
     * the stroke style is modified via the library-provided methods.
     */
    finishStrokeStyleEvents: function () {
        if (this._strokeStyleChanged) {
            this._strokeStyleChanged = false;
            this.onEndStrokeStyleChange.trigger();
    ...
    setFillStyle: function (fillStyle) {
        ...
        this.finishFillStyleEvents();
    },

    _setFillStyle: function (fillStyle) {
        this.beginFillStyleChange();
    ...
    /**
     * Call this method before changing the fill style of this element.
     */
    beginFillStyleChange: function () {
        if (!this._fillStyleChanged) {
            this._fillStyleChanged = true;
            this.onBeginFillStyleChange.trigger();
    ...
    /**
     * A drawing element uses three events to signal the change of the fill style:
     * {@link Webgram.DrawingElement#onBeginFillStyleChange},
     * {@link Webgram.DrawingElement#onFillStyleChange} and 
     * {@link Webgram.DrawingElement#onEndFillStyleChange}.
     * This method assures a successive and uniform triggering
     * of the three events. It is automatically invoked when
     * the fill style is modified via the library-provided methods.
     */
    finishFillStyleEvents: function () {
        if (this._fillStyleChanged) {
            this._fillStyleChanged = false;
            this.onEndFillStyleChange.trigger();
     ...
     * The base rectangle is defined as the smallest rectangle that includes
     * all the <em>untransformed</em> shape points. The base rectangle is very important
     * to the element, because it determines the size of the element.
     * @returns {Webgram.Geometry.Rectangle} the base rectangle
     */
    getBaseRectangle: function () {
        /* the base rectangle is cached for better performance */
        if (!this._baseRectangle) {
            this._baseRectangle = this._computeBaseRectangle();
            this.restoreProportionalPoints();
        }
        
        return this._baseRectangle;
    },

    _computeBaseRectangle: function () {
        return this.getShape().getBoundingRectangle();
    },
    
    /**
     * Returns the <em>bounding rectangle</em> of this element.
     * The bounding rectangle is defined as the smallest rectangle,
     * relative to the parent, that includes all the shape points.
     * @param {Boolean} transformed if <tt>true</tt> returns the bounding
     * rectangle of the transformed shape points, otherwise returns the bounding
     * rectangle of the untransformed shape points
     * @returns {Webgram.Geometry.Rectangle} the bounding rectangle
     */
    getBoundingRectangle: function (transformed) {
        if (transformed) {
            return this.transformDirect(this.getShape()).getBoundingRectangle();
        }
        else {
            return this.getShape().getBoundingRectangle();
        }
    ...
    /**
     * Builds and object with the bounding points of this element.
     * @param {Boolean} transformed if <tt>true</tt> returns the boundaries
     * transformed (relative to the parent), otherwise returns the boundaries
     * untransformed (relative to this element)
     ...
     * </ul>
     */
    getBoundingPoints: function (transformed) {
        var boundingRectangle = this.getBoundingRectangle(transformed);
        
        return {
            topLeft: boundingRectangle.getTopLeft(),
            top: boundingRectangle.getTop(),
            topRight: boundingRectangle.getTopRight(),
            right: boundingRectangle.getRight(),
            bottomRight: boundingRectangle.getBottomRight(),
            bottom: poly.boundingRectangle.getBottom(),
            bottomLeft: boundingRectangle.getBottomLeft(),
            left: boundingRectangle.getLeft()
        };
    },

    /**
     * Returns the width of this element. The width of an element
     * does not depend on the transforms that are applied.<br><br>
     * <em>(should not be overridden)</em>
    ...
    snap: function (index) {
        ...
        if (index == null) { /* snap the whole element */
            ...
            if (minDeltaX < Infinity) {
                this._setCenter(this.getCenter().getTranslated(minDeltaX, 0));
            }
            if (minDeltaY < Infinity) {
                this._setCenter(this.getCenter().getTranslated(0, minDeltaY));
            }
            ...
            var transformedShape = this.getShape(true);
            this._setShapePoint(index, transformedShape.points[index], true, false);
        }
    },
    ...
    getSnappingPoints: function () {
        ...
        points.push(this.getCenter().round());
    ...
    _snapShapePoint: function (index, point, fixedPoints, rotationAngle, center) {
        ...
        if (this.isSnapInternallyEnabled() && !this.isEnclosed()) {
        ...
        if ((snappedX == null || snappedY == null) && this.isSnapExternallyEnabled() && !this.isEnclosed()) {
        ...
        if (this.isSnapToGridEnabled() && (snappedX == null || snappedY == null) && !this.isEnclosed()) {
    ...
    saveParentRelativePosition: function () {
        ...
        var shapeLen = this.getShape().points.length;
        
        this._parentRelativePositions = [];
        for (var i = 0; i < shapeLen; i++) {
            var point = this.getShapePoint(i, true);
        ...
        /* also save the relative position of the center */
        var center = this.getCenter();
        this._parentRelativePositions.push({
            x: center.x / (parentWidth - 1),
            y: center.y / (parentHeight - 1)
        });
    },
     ...
     * @returns {Boolean} <tt>true</tt> if at least one point has been actually
     * changed, or <tt>false</tt> if all the points were kept the same
    ...
    restoreParentRelativePosition: function () {
        ...
        for (var i = 0; i < shape.points.length; i++) {
            ...
            this._setShapePoint(i, point, true, false);
        }
    },
    ...
    _enterContainerElement: function (containerElement, triggerEvents) {
        ...
        this.setShape(this.getShape().getTranslated(-blockCenter.x, -blockCenter.y));
    ...
    _leaveContainerElement: function (triggerEvents) {
        ...
        if (oldParent.getRotationAngle() !== 0) {
            ...
            this.setShape(this.getShape().getTranslated(deltaX, deltaY));
            this._rotationAngle += oldParent.getRotationAngle();
        }
        else {
            this.setShape(this.getShape().getTranslated(parentCenter.x, parentCenter.y));
        }
     ...
     * {@link Webgram.Geometry.Point} which is automatically adjusted to maintain its relative position to the center of the element.
     * @param {Webgram.Geometry.Point} point the proportional point to add
     * @param {Function} onChange a function to be called whenever the point is changed;
     * it will be called with the element as <tt>this</tt>, and the point as argument
     */
    addProportionalPoint: function (point, onChange) {
        this._proportionalPoints.push({
            point: point,
            onChange: onChange,
    ...
    remProportionalPoint: function (point) {
        this._proportionalPoints.splice(this._getProportionalPointIndex(point), 1);
    },
    ...
    saveProportionalPoint: function (point) {
        var index = this._getProportionalPointIndex(point);
        ...
        this._proportionalPoints[index].relativePosition = {x: x, y: y};
    },
    ...
    restoreProportionalPoints: function () {
        ...
        for (var i = 0; i < this._proportionalPoints.length; i++) {
            var proportionalPoint = this._proportionalPoints[i];
            
            proportionalPoint.point.x = (width - 1) * proportionalPoint.relativePosition.x;
            proportionalPoint.point.y = (height - 1) * proportionalPoint.relativePosition.y;
            
            if (proportionalPoint.onChange != null) {
                proportionalPoint.onChange.call(this, proportionalPoint.point);
            }
        }
    },
    
    _getProportionalPointIndex: function (point) {
        return Webgram.Utils.indexOf(this._proportionalPoints, point, function (obj, point) {
     ...
     * called for shape, rotation angle, styles and flipping states.<br><br>
     * <em>(should not be overridden)</em>
     */
    ...
    /**
     * Prepares a json object with the center of this element.<br><br>
     * <em>(could be overridden)</em>
     * @returns {Object} the json object with the center
     */
    centerToJson: function () {
     ...
     */
    centerFromJson: function (json) {
        this._center = new Webgram.Geometry.Point(json.x, json.y);
    },
...
//        }
    ...
    /**
     * Prepares a json object with the z-index of this element.<br><br>
     * <em>(could be overridden)</em>
     * @returns {Object} the json object with the z-index
     */
    zIndexToJson: function () {
        return this.zIndex; // TODO this should not be part of the json data
    },
    
    /**
     * Restores the z-index of this element from a json object.<br><br>
     * <em>(could be overridden)</em>
     * @param {Object} json the json object with the z-index
     */
    zIndexFromJson: function (json) {
        this.zIndex = json;
    },
    
    /**
     * Prepares a json object with the flipping state of this element.<br><br>
     * <em>(could be overridden)</em>
    ...
    strokeStyleFromJson: function (json) {
        ...
        this._setGradientProportionalPoints(this._strokeStyle);
        this.setGradientEditEnabled(gradientEditEnabled);
    },
    ...
    /**
     * Prepares a json object with the text style of this element.<br><br>
     * <em>(could be overridden)</em>
     ...
     * {@link Webgram.DrawingElement#fromJson}.<br><br>
     * <em>(should not be overridden)</em>
    ...
    toJson: function (useObjRefs) {
        ...
        var centerJson = this.centerToJson();
        ...
        var zIndexJson = this.zIndexToJson();
        if (zIndexJson != undefined) {
            json['zIndex'] = zIndexJson;
        }
    ...
    fromJson: function(json) {
        ...
        if (json.zIndex !== undefined) {
            this.zIndexFromJson(json.zIndex);
        }
     ...
     * @see {Webgram.DrawingElement#finishStrokeStyleEvents}
     * @see {Webgram.DrawingElement#finishFillStyleEvents}
     */
    finishChangeEvents: function () {
        ...
        var onEndChangeAttribute = null;
        this.onEndChange.bind(function (attribute) {
            onEndChangeAttribute = attribute;
        });
        ...
        if (onEndChangeAttribute) {
            this.onEndChange.trigger(onEndChangeAttribute);
        }
    },
