...
Webgram.DrawingElement = Webgram.Class.extend( /** @lends Webgram.DrawingElement.prototype */ {
    ...
    duplicate: function (add, overrideJson) {
        ...
        drawingElement = new json.cls(); /* create an instance of this class with default properties */
     ...
     * will not exist.<br><br>
     * <em>(should not be overridden)</em>
     * @param {Boolean} useObjRefs include the class itself instead of its full name
     * (makes the resulting json usable only locally)
     * @returns {Object} the json object with the class information
     */
    classToJson: function (useObjRefs) {
        if (useObjRefs) {
    ...
    toJson: function (useObjRefs) {
        ...
        var classJson = this.classToJson(useObjRefs);
...
/** @lends Webgram.DrawingElement */ {
    ...
    onExtend: function (childClass) {
        Webgram.DrawingElements._registerClass(childClass, childClass.getName());
    }
});
