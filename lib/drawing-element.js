...
Webgram.DrawingElement = function (id, points) {
    if (points == null || points.length === 0) {
        points = [Webgram.Geometry.Point.zero()];
    }
     ...
     * @type Webgram.Event
     */
    this.onShapeBeginChange = new Webgram.Event('begin change', this); /* () */
     ...
     * @type Webgram.Event
     */
    this.onShapeEndChange = new Webgram.Event('end change', this); /* () */
     ...
     * @type Webgram.Event
     */
    this.onShapeChange = new Webgram.Event('change', this); /* () */
...
Webgram.DrawingElement.prototype = {
     ...
     * This method assures a successive and uniform trigger
