...
Webgram.DrawingElement = Webgram.Class.extend( /** @lends Webgram.DrawingElement.prototype */ {
     ...
     * element has to fit
     * @param {Boolean} test if <tt>true</tt> then no actual change is performed
     * @returns {Webgram.Geometry.Rectangle} the new bounding rectangle,
     * relative to this element
     */
    fit: function (rectangle, test) {
