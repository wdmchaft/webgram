...
/**
 * @class Represents clickable menu item around a drawing element.
 ...
 * @param {String} align a combination between ('l', 'c', 'r') and  ('t', 'c', 'b') indicating the aligment of this item
 */
Webgram.ActionMenuItem = function (icon, callback, align) {
...
Webgram.ActionMenuItem.prototype = {
    draw: function () {
        ...
        if (this.getFocusType() === Webgram.ActionMenuItem.FOCUS_HOVERED) {
            ...
            this.drawImage(image.content, Webgram.Geometry.Point.zero(), image.size, 0, 1);
        }
        else {
            this.paint();
            this.drawImage(image.content, Webgram.Geometry.Point.zero(), image.size, 0, 0.5);
        }
    },
    ...
    computeAnchor: function () {
        var bounds = this.drawingElement.getBounds();
        
        if (this.align[0] === 't') {
            if (this.align[1] === 'l') {
                return this.drawingElement.transformInverse(bounds.topLeft);
            }
            else if (this.align[1] === 'c') {
                return this.drawingElement.transformInverse(bounds.top);
            }
            else if (this.align[1] === 'r') {
                return this.drawingElement.transformInverse(bounds.topRight);
            }
        }
        if (this.align[0] === 'b') {
            if (this.align[1] === 'l') {
                return this.drawingElement.transformInverse(bounds.bottomLeft);
            }
            else if (this.align[1] === 'c') {
                return this.drawingElement.transformInverse(bounds.bottom);
            }
            else if (this.align[1] === 'r') {
                return this.drawingElement.transformInverse(bounds.bottomRight);
            }
        }
        if (this.align[0] === 'l') {
            if (this.align[1] === 't') {
                ...
                return this.drawingElement.transformInverse(bounds.left);
            }
        ...
        if (this.align[0] === 'r') {
            if (this.align[1] === 't') {
                ...
                return this.drawingElement.transformInverse(bounds.right);
            }
            else if (this.align[1] === 'b') {
                return this.drawingElement.transformInverse(bounds.bottomRight);
            }
...
Webgram.Class('Webgram.ActionMenuItem', Webgram.ControlPoint);
