...
Webgram.DrawingElements.PolyElement =
    ...
    finishShapeEvents: function () {
        /* we override this method because we want to call _recenter()
         * right before finishing the shape events */
        
        this._recenter();
        
        Webgram.DrawingElements.PolyElement.parent.finishShapeEvents.call(this);
    },
