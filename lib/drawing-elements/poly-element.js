...
Webgram.DrawingElements.PolyElement =
     ...
     */
    initialize: function PolyElement(points) {
        Webgram.DrawingElements.PolyElement.parentClass.call(this);
    ...
    shapeToJson: function () {
        ...
        Webgram.Utils.forEach(this._points, function (point) {
            json.push({
                x: point.x,
                y: point.y
            });
    ...
    shapeFromJson: function (json) {
        ...
        Webgram.Utils.forEach(this.getPolyControlPoints(), function (controlPoint) {
            this.remControlPoint(controlPoint);
        }, this);
        ...
        Webgram.Utils.forEach(json, function (pointJson) {
            this._points.push(new Webgram.Geometry.Point(pointJson.x, pointJson.y));
        }, this);
