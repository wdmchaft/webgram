...
Webgram.DrawingElements.ContainerElement = 
            Webgram.DrawingElements.RectangularElement.extend( /** @lends Webgram.DrawingElements.ContainerElement.prototype */ {
                
    /**
     * A rectangular drawing element that behaves like a container for other elements.
     * @constructs Webgram.DrawingElements.ContainerElement
     * @extends Webgram.DrawingElements.RectangularElement
     */
    initialize: function ContainerElement(id, x, y, width, height) {
    ...
    drawImage: function (image, center, size, rotationAngle, alpha, transformSet) {
        if (transformSet) { /* called from a child */
            ...
            this.callSuper(image, center, size, rotationAngle, alpha);
        }
    },
    ...
    drawText: function (text, box, textStyle, transformSet) {
        ...
        if (transformSet) { /* called from a child */
            ...
            this.callSuper(text, box, textStyle);
        }
    },
    ...
    paint: function (strokeStyle, fillStyle, transformSet) {
        ...
        if (transformSet) { /* called from a child */
            ...
            this.callSuper(strokeStyle, fillStyle);
        }
    },
    ...
    _setShapePoint: function (index, point, transformed, snap) {
        this.callSuper(index, point, transformed, snap);
...
//                }
    ...
    _setTop: function (point, snap, noFlip) {
        this.callSuper(point, snap, noFlip);
    ...
    _setWidth: function (width, snap) {
        this.callSuper(width, snap);
        
        this._restoreChildrenRelativePositions();
    },
    
    _setHeight: function (height, snap) {
        this.callSuper(height, snap);
