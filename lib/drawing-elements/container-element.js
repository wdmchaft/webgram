...
//                }
    ...
    _setWidth: function (width) {
        Webgram.DrawingElements.RectangularElement.prototype._setWidth.call(this, width);
        
        this._restoreChildrenRelativePositions();
    },
    
    _setHeight: function (height) {
        Webgram.DrawingElements.RectangularElement.prototype._setHeight.call(this, height);
    ...
    _restoreChildrenRelativePositions: function () {
        ...
        for (var i = 0; i < this.drawingElements.length; i++) {
            var drawingElement = this.drawingElements[i];
            if (!drawingElement.restoreParentRelativePosition()) {
                allChanged = false;
            }
        }
