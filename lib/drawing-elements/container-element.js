...
Webgram.DrawingElements.ContainerElement = 
    ...
    _addDrawingElement: function (drawingElement, where, triggerEvents) {
        ...
        if (oldParent) {
            var oldAbsLocation = oldParent.getAbsoluteLocation();
            var thisAbsLocation = this.getAbsoluteLocation();
            var deltaX = oldAbsLocation.x - thisAbsLocation.x;
            var deltaY = oldAbsLocation.y - thisAbsLocation.y;
            
            drawingElement._setLocation(drawingElement.getLocation().getTranslated(deltaX, deltaY), false);
        }
