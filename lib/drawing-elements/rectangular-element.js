...
Webgram.DrawingElements.RectangularElement.prototype = {
    ...
    getDrawingPoly: function () {
        var shape = new Webgram.Geometry.Poly([
            this.shape.points[Webgram.DrawingElements.RectangularElement.TOP_LEFT],
            new Webgram.Geometry.Point(
                this.shape.points[Webgram.DrawingElements.RectangularElement.BOTTOM_RIGHT].x,
                this.shape.points[Webgram.DrawingElements.RectangularElement.TOP_LEFT].y),
            this.shape.points[Webgram.DrawingElements.RectangularElement.BOTTOM_RIGHT],
            new Webgram.Geometry.Point(
                this.shape.points[Webgram.DrawingElements.RectangularElement.TOP_LEFT].x,
                this.shape.points[Webgram.DrawingElements.RectangularElement.BOTTOM_RIGHT].y)
        ]);
    ...
    getSnappingPoints: function () {
        var points = Webgram.Utils.clone(this.rotateDirect(this._getFourPointsShape()).points);
    ...
    restoreParentRelativePosition: function () {
        ...
        this.shape.points[Webgram.DrawingElements.RectangularElement.TOP_LEFT] = new Webgram.Geometry.Point(left, top);
        this.shape.points[Webgram.DrawingElements.RectangularElement.BOTTOM_RIGHT] = new Webgram.Geometry.Point(right, bottom);
    ...
    setKeepAspectRatioEnabled: function (enabled, aspectRatio) {
        if (enabled) {
            if (this._aspectRatio == null || aspectRatio != null) { /* avoid setting the aspect ratio if already set */
                ...
                /* call the setBottomRight method to apply the new aspect ratio constraint */
                var rotatedShape = this.rotateDirect(this.shape);
                var bottomRight = rotatedShape.points[Webgram.DrawingElements.RectangularElement.BOTTOM_RIGHT];
                this._setBottomRight(bottomRight);
            }
    ...
    _setTop: function (point, noSnapFeedback) {
        ...
        this.shape.points[Webgram.DrawingElements.RectangularElement.TOP_LEFT] = new Webgram.Geometry.Point(x1, y1);
        this.shape.points[Webgram.DrawingElements.RectangularElement.BOTTOM_RIGHT] = new Webgram.Geometry.Point(x2, y2);
    ...
    _setRight: function (point, noSnapFeedback) {
        var shape = this._getFourPointsShape();
        var rotatedShape = this.rotateDirect(shape);
        var rotationAngle = this.getRotationAngle();
        var oldCenter = this.shape.getCenter();
    ...
    _setBottom: function (point, noSnapFeedback) {
        var shape = this._getFourPointsShape();
        var rotatedShape = this.rotateDirect(shape);
        var rotationAngle = this.getRotationAngle();
        var oldCenter = this.shape.getCenter();
    ...
    _setLeft: function (point, noSnapFeedback) {
        var shape = this._getFourPointsShape();
        var rotatedShape = this.rotateDirect(shape);
        var rotationAngle = this.getRotationAngle();
        var oldCenter = this.shape.getCenter();
    ...
    _setTopLeft: function (point, noSnapFeedback) {
        this._setRotatedShapePoint(Webgram.DrawingElements.RectangularElement.TOP_LEFT, point, noSnapFeedback);
        
        this.onResize.trigger();
    },
    
    _setBottomRight: function (point, noSnapFeedback) {
        this._setRotatedShapePoint(Webgram.DrawingElements.RectangularElement.BOTTOM_RIGHT, point, noSnapFeedback);
        
        this.onResize.trigger();
    },
    
    _setTopRight: function (point, noSnapFeedback) {
        var shape = this._getFourPointsShape();
        var rotatedShape = this.rotateDirect(shape);
        var rotationAngle = this.getRotationAngle();
        var oldCenter = this.shape.getCenter();
        ...
        this.shape.points[Webgram.DrawingElements.RectangularElement.TOP_LEFT] = nrTopLeft;
        this.shape.points[Webgram.DrawingElements.RectangularElement.BOTTOM_RIGHT] = nrBottomRight;
    ...
    _setBottomLeft: function (point, noSnapFeedback) {
        var shape = this._getFourPointsShape();
        var rotatedShape = this.rotateDirect(shape);
        var rotationAngle = this.getRotationAngle();
        var oldCenter = this.shape.getCenter();
    ...
    _setWidth: function (width, noSnapFeedback) {
        ...
        var rotationAngle = this.getRotationAngle();
        var nrTopLeft = this.shape.points[Webgram.DrawingElements.RectangularElement.TOP_LEFT];
        var nrBottomRight = this.shape.points[Webgram.DrawingElements.RectangularElement.BOTTOM_RIGHT];
...
Webgram.DrawingElements.RectangularElement.ResizeTopLeftControlPoint.prototype = {
    getCursor: function () {
        return Webgram.Utils.getCursorByAngle(this.drawingElement.getRotationAngle() - 3 * Math.PI / 4);
    },
...
Webgram.DrawingElements.RectangularElement.ResizeTopRightControlPoint.prototype = {
    getCursor: function () {
        return Webgram.Utils.getCursorByAngle(this.drawingElement.getRotationAngle() - Math.PI / 4);
    },
...
Webgram.DrawingElements.RectangularElement.ResizeTopControlPoint.prototype = {
    getCursor: function () {
        return Webgram.Utils.getCursorByAngle(this.drawingElement.getRotationAngle() - Math.PI / 2);
    },
...
Webgram.DrawingElements.RectangularElement.ResizeLeftControlPoint.prototype = {
    getCursor: function () {
        return Webgram.Utils.getCursorByAngle(this.drawingElement.getRotationAngle() + Math.PI);
    },
...
Webgram.DrawingElements.RectangularElement.ResizeRightControlPoint.prototype = {
    getCursor: function () {
        return Webgram.Utils.getCursorByAngle(this.drawingElement.getRotationAngle());
    },
