...
Webgram.DrawingElements.RectangularElement.prototype = {
    ...
    getSnappingPoints: function () {
        var points = this.rotateDirect(this._getFourPointsShape(true)).points;
    ...
    _getFourPointsShape: function (scaled) {
        var points = this.getShape(false, scaled).points;
...
Webgram.DrawingElements.RectangularElement.ResizeTopLeftControlPoint.prototype = {
    computeAnchor: function () {
        return this.drawingElement.transformInverse(this.drawingElement.getBounds().topLeft);
    },
...
Webgram.DrawingElements.RectangularElement.ResizeTopRightControlPoint.prototype = {
    computeAnchor: function () {
        return this.drawingElement.transformInverse(this.drawingElement.getBounds().topRight);
    },
...
Webgram.DrawingElements.RectangularElement.ResizeBottomLeftControlPoint.prototype = {
    computeAnchor: function () {
        return this.drawingElement.transformInverse(this.drawingElement.getBounds().bottomLeft);
    },
...
Webgram.DrawingElements.RectangularElement.ResizeBottomRightControlPoint.prototype = {
    computeAnchor: function () {
        return this.drawingElement.transformInverse(this.drawingElement.getBounds().bottomRight);
    },
...
Webgram.DrawingElements.RectangularElement.ResizeTopControlPoint.prototype = {
    computeAnchor: function () {
        return this.drawingElement.transformInverse(this.drawingElement.getBounds().top);
    },
...
Webgram.DrawingElements.RectangularElement.ResizeBottomControlPoint.prototype = {
    computeAnchor: function () {
        return this.drawingElement.transformInverse(this.drawingElement.getBounds().bottom);
    },
...
Webgram.DrawingElements.RectangularElement.ResizeLeftControlPoint.prototype = {
    computeAnchor: function () {
        return this.drawingElement.transformInverse(this.drawingElement.getBounds().left);
    },
...
Webgram.DrawingElements.RectangularElement.ResizeRightControlPoint.prototype = {
    computeAnchor: function () {
        return this.drawingElement.transformInverse(this.drawingElement.getBounds().right);
    },
