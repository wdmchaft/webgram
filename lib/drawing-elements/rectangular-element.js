...
Webgram.DrawingElements.RectangularElement = Webgram.DrawingElement.extend( /** @lends Webgram.DrawingElements.RectangularElement */ {
     ...
     */
    initialize: function MyElement(id, width, height) {
        this.callSuper(id);
        ...
        this._resizeControlPoints = null;
    },
    ...
    setWidth: function (width, fixedSide) {
        this._setWidth(width, fixedSide, false);
        this.finishShapeEvents();
    },

    _setWidth: function (width, fixedSide, snap) {
        ...
        size = size.getRotated(this.getRotationAngle());
        
        if (size.width !== 0 || size.height !== 0) {
            this._setLocation(this.getLocation().getTranslated(size.width, size.height), snap);
        }
    ...
    setHeight: function (height, fixedSide) {
        this._setHeight(height, fixedSide, false);
        this.finishShapeEvents();
    },

    _setHeight: function (height, fixedSide, snap) {
    ...
    _setTopLeft: function (topLeft, snap) {
        ...
        this._setWidth(width, Webgram.DrawingElements.RectangularElement.SIDE_RIGHT, snap);
        this._setHeight(height, Webgram.DrawingElements.RectangularElement.SIDE_BOTTOM, snap);
    },
    ...
    _setTopRight: function (topRight, snap) {
        ...
        this._setWidth(width, Webgram.DrawingElements.RectangularElement.SIDE_LEFT, snap);
        this._setHeight(height, Webgram.DrawingElements.RectangularElement.SIDE_BOTTOM, snap);
    },
    ...
    _setBottomRight: function (bottomRight, snap) {
        ...
        this._setWidth(width, Webgram.DrawingElements.RectangularElement.SIDE_LEFT, snap);
        this._setHeight(height, Webgram.DrawingElements.RectangularElement.SIDE_TOP, snap);
    },
    ...
    /**
     * Tells if the interactive resizing is enabled for this element.
     * @returns {Boolean} <tt>true</tt> if the interactive resizing is enabled,
     * <tt>false</tt> otherwise.
     */
    isResizeEnabled: function () {
        return this._resizeControlPoints != null;
    },
    
    /**
     * Enables or disables the interactive resizing for this element.
     * @param {Boolean} enabled <tt>true</tt> to enable the resizing,
     * <tt>false</tt>otherwise.
     */
    setResizeEnabled: function (enabled) {
        if (enabled && this._resizeControlPoints == null) {
            /* enable */
            
            this._resizeControlPoints = {
            ...
            this.addControlPoint(this._resizeControlPoints.topLeft);
            this.addControlPoint(this._resizeControlPoints.topRight);
            this.addControlPoint(this._resizeControlPoints.bottomRight);
            this.addControlPoint(this._resizeControlPoints.bottomLeft);
            
            this.addControlPoint(this._resizeControlPoints.top);
            this.addControlPoint(this._resizeControlPoints.right);
            this.addControlPoint(this._resizeControlPoints.bottom);
            this.addControlPoint(this._resizeControlPoints.left);
        }
        else if (!enabled && this._resizeControlPoints != null) {
            /* disable */
            
            this.remControlPoint(this._resizeControlPoints.topLeft);
            this.remControlPoint(this._resizeControlPoints.topRight);
            this.remControlPoint(this._resizeControlPoints.bottomRight);
            this.remControlPoint(this._resizeControlPoints.bottomLeft);
            
            this.remControlPoint(this._resizeControlPoints.top);
            this.remControlPoint(this._resizeControlPoints.right);
            this.remControlPoint(this._resizeControlPoints.bottom);
            this.remControlPoint(this._resizeControlPoints.left);
...
// TODO functionality to be moved back to DrawingElement:
